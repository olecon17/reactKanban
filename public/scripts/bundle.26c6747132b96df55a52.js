...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_components_LoadSpinner__ = __webpack_require__(111);
    ...
    childRoutes: [{
        ...
        indexRoute: {
            getComponent: function getComponent(location, cb) {
                Object(__WEBPACK_IMPORTED_MODULE_0_app_components_LoadSpinner__["a" /* default */])(__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 170)), cb, 'home');
            }
        }
    }]
};
...
/* harmony default export */ __webpack_exports__["a"] = (WebSiteRoutes);
...
var LoadSpinner = function LoadSpinner(component, callback, script_name) {
    var previousLoaded = Object.keys(scripts).every(function (script) {
    ...
    var allLoaded = Object.keys(scripts).every(function (script) {
        return scripts[script] === true;
    });
    var load_msg = '';

    if (previousLoaded) {
        load_msg = __WEBPACK_IMPORTED_MODULE_1_antd_lib_message___default.a.loading('Loading...', 0);
    }
...
/* harmony default export */ __webpack_exports__["a"] = (LoadSpinner);
